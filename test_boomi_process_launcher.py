...
class TestUtility(ut1.TestCase):
    def setUp(self):
        self.boomi = BoomiAPI("api_url", "path_url", "username", "password", "atom_name", "process_name", False, None, False)
    ...
    def test_parse_dynamic_properties_valid(self):
        ...
        self.boomi = BoomiAPI("api_url", "path_url", "username", "password", "atom_name", "process_name", False, "key1:value1;key2:value2", True)
    ...
    def test_parse_dynamic_properties_invalid(self):
        ...
        self.boomi = BoomiAPI("api_url", "path_url", "username", "password", "atom_name", "process_name", False, "key1:value1;key2", True)
...
class TestPrintLogMessage(ut1.TestCase):
    ...
    def test_format_log_message(self, mock_datetime, mock_boomi_api):
        ...
        mock_boomi_api.now.return_value = mock_datetime.now.return_value = datetime.datetime.strptime("2024-01-01 08:01:02", "%Y-%m-%d %H:%M:%S")
        groups = [
            ...
            ('1+2+3+4', '12345', 'section2', 'section3', 'section4'),
        ]
